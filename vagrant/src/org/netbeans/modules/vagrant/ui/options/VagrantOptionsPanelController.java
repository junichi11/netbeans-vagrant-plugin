...
@OptionsPanelController.SubRegistration(
        id = "Vagrant",
        location = "Advanced",
        displayName = "#AdvancedOption_DisplayName_Vagrant",
        keywords = "#AdvancedOption_Keywords_Vagrant",
        keywordsCategory = "Advanced/Vagrant")
@org.openide.util.NbBundle.Messages({"AdvancedOption_DisplayName_Vagrant=Vagrant", "AdvancedOption_Keywords_Vagrant=vagrant,Vagrant"})
public final class VagrantOptionsPanelController extends OptionsPanelController {

    private VagrantPanel panel;
