...
public abstract class VagrantAction extends AbstractAction {
    ...
    public VagrantAction(String name, Icon icon) {
        super(name, icon);
        this.name = name;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (project == null) {
            if (!Bundle.CTL_VagrantBoxAddAction().equals(name)
                    && !Bundle.CTL_VagrantPluginInstallAction().equals(name)
                    && !Bundle.CTL_VagrantOpenOptionsAction().equals(name)) {
                return;
            }
        }
    ...
    public abstract void actionPerformed(Project project);
}
