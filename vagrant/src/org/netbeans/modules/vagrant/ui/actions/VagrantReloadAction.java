...
public final class VagrantReloadAction extends VagrantAction {
    ...
    private static final long serialVersionUID = 1802647122965661013L;
    private static final Logger LOGGER = Logger.getLogger(VagrantReloadAction.class.getName());

    public VagrantReloadAction() {
        super(Bundle.CTL_VagrantReloadAction(), VagrantUtils.getIcon(VagrantUtils.RELOAD_ICON_16));
    }
    ...
    public void actionPerformed(Project project) {
        try {
            ...
            vagrant.reload(VagrantProjectImpl.create(project));
