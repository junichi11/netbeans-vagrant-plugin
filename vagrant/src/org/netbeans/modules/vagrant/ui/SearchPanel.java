...
import org.netbeans.modules.vagrant.utils.UiUtils.SearchWindow.SearchWindowSupport;
...
/**
 * Copy from org.netbeans.modules.php.api.ui.SearchPanel.
 *
 * Heavily inspired by Andrei's
 * {@link org.netbeans.modules.spring.beans.ui.customizer.SelectConfigFilesPanel}.
 *
 * @author Tomas Mysik
 */
public final class SearchPanel extends JPanel {
    ...
    private SearchPanel(SearchWindowSupport support) {
        ...
        rp = new RequestProcessor("Vagrant Search Panel detection thread (" + support.getPleaseWaitPart() + ")", 1, true); // NOI18N
    ...
    private void initComponents() {
        ...
        foundItemsList.getAccessibleContext().setAccessibleName(NbBundle.getMessage(SearchPanel.class, "SearchPanel.foundItemsList.AccessibleContext.accessibleName")); // NOI18N
        foundItemsList.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(SearchPanel.class, "SearchPanel.foundItemsList.AccessibleContext.accessibleDescription")); // NOI18N
        ...
        detectedFilesLabel.getAccessibleContext().setAccessibleName(NbBundle.getMessage(SearchPanel.class, "SearchPanel.detectedFilesLabel.AccessibleContext.accessibleName")); // NOI18N
        detectedFilesLabel.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(SearchPanel.class, "SearchPanel.detectedFilesLabel.AccessibleContext.accessibleDescription")); // NOI18N
        foundItemsScrollPane.getAccessibleContext().setAccessibleName(NbBundle.getMessage(SearchPanel.class, "SearchPanel.foundItemsScrollPane.AccessibleContext.accessibleName")); // NOI18N
        foundItemsScrollPane.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(SearchPanel.class, "SearchPanel.foundItemsScrollPane.AccessibleContext.accessibleDescription")); // NOI18N
        messageLabel.getAccessibleContext().setAccessibleName(NbBundle.getMessage(SearchPanel.class, "SearchPanel.messageLabel.AccessibleContext.accessibleName")); // NOI18N
        messageLabel.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(SearchPanel.class, "SearchPanel.messageLabel.AccessibleContext.accessibleDescription")); // NOI18N
        progressBar.getAccessibleContext().setAccessibleName(NbBundle.getMessage(SearchPanel.class, "SearchPanel.progressBar.AccessibleContext.accessibleName")); // NOI18N
        progressBar.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(SearchPanel.class, "SearchPanel.progressBar.AccessibleContext.accessibleDescription")); // NOI18N

        getAccessibleContext().setAccessibleName(NbBundle.getMessage(SearchPanel.class, "SearchPanel.AccessibleContext.accessibleName")); // NOI18N
        getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(SearchPanel.class, "SearchPanel.AccessibleContext.accessibleDescription")); // NOI18N
